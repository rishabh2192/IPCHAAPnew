...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link href="Stylesheets/privacypolicy.css" type="text/css" rel="Stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
        
        <div style="text-align:center;">
            <span class="Heading" >Privacy Policy</span><br /><br />
        </div>
        ...
        <span class="heading_policy_submain">1. Collection of Personally Identifiable Information and other Information</span>
        <br /><br />
        <div class="heading_policy_content">
        ...
        <span class="heading_policy_submain">2. Use of Demographic / Profile Data / Your Information </span>
         <br /><br />
         <div class="heading_policy_content">
        ...
        <span class="heading_policy_submain">3. Sharing of personal information</span>
         <br /><br />
         <div class="heading_policy_content">
        ...
        <span class="heading_policy_submain">4. Links to Other Sites</span>
         <br /><br />
         <div class="heading_policy_content">
        Our Website links to other websites that may collect personally identifiable information about you. IP Chaap.com is not responsible for the privacy practices or the content of those linked websites.
        <br /><br /><br />
        </div>
        <span class="heading_policy_submain">5. Security Precautions</span>
         <br /><br />
         <div class="heading_policy_content">
        ...
        <span class="heading_policy_submain">6. Choice/Opt-Out</span>
         <br /><br />
         <div class="heading_policy_content">
        ...
        <br /><br />
        If you want to remove your contact information from all IPChaap.com lists and newsletters, Please Contact us through the <a style="font-weight:bold;" href="Contact.aspx">Contact Us</a> Page With Your User-Id.
        <br /><br /><br />
        </div>
        <span class="heading_policy_submain">7. Advertisements on IPChaap.com</span>
         <br /><br />
         <div class="heading_policy_content">
        ...
        <span class="heading_policy_submain">8. Your Consent</span>
         <br /><br />
         <div class="heading_policy_content">
        ...
        <span class="heading_policy_submain">9. Questions?</span>
         <br /><br />
         <div class="heading_policy_content">
        Questions regarding this statement should be directed to the following address: ipchaap@gmail.com
        </div>
    </div>
</asp:Content>
